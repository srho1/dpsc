...
parser.add_argument('--n', type=int, default=10, help='# donors')
...
# parser.add_argument('--lmbda', type=float, default=10.0, help='lmbda, regularization coefficient') # fixed to be = T0
parser.add_argument('--eps1', type=float, default=2.0, help='eps1, privacy budget for step 1')
parser.add_argument('--eps2', type=float, default=2.0, help='eps2, privacy budget for step 2')
...
# In this experiment, we now fix lambda to be T0.
...
# lambda for output perturbation = T0
args.lmbda = args.T0
